...
/*   Updated: 2023/11/15 16:46:01 by nsahinog         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	search_path(t_mparse *data, int i, t_shell *m_shell)
{
	char	*value;
	char	*str;
	int		x;
...
void	run_execve(t_mparse *parse, char **env, int *fd, t_shell *m_shell)
{
	char		**full_cmd;
...
void	exec_others(t_mparse *parse, char **env, int *fd, t_shell *m_shell)
{
